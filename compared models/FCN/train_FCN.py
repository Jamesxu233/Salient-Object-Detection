...
data_dir = 'E:/data/'
tra_image_dir = 'CRACK dataset/CRACK500/traincrop/traincrop/'
tra_label_dir = 'CRACK dataset/CRACK500/traincrop/traincrop/'

image_ext = '.jpg'
label_ext = '.png'

model_dir = "E:/saved_models/FCN/"
...
for epoch in range(0,epoch_num):
    ...
    for i, data in enumerate(salobj_dataloader):
        ...
        if ite_num % 200==0:  # save model every 200 iterations
            ...
            torch.save(net.state_dict(), model_dir+"FCN_bce_itr_%d_train_%3f.pth" % (ite_num, running_loss / ite_num4val))
            running_loss=0.0
